package com.sun.library.controller;

import com.sun.library.pojo.Book;
import com.sun.library.pojo.BookCommand;
...
public class BookController {
    ...
    public String addBookDo(BookCommand bookAddCommand, RedirectAttributes redirectAttributes){
        Book book=new Book();
        book.setBookId(0);
    ...
    public String bookEditDo(HttpServletRequest request,BookCommand bookAddCommand,RedirectAttributes redirectAttributes){
